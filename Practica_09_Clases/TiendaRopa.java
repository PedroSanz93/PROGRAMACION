...
public class TiendaRopa {
    // Atributos
    private int CodProducto; // codigo de producto en privado para que no se pueda modificar
    private int IDTienda; // ID de tieda protegido para que solo se pueda modificar si es necesario con get y set
    public double precio; // precio en publico porque si hay algun tipo de perido de rebajas se pueda modificar desde la app
    
    // constructor
    TiendaRopa(int CodProducto, int IDTienda, double precio){
