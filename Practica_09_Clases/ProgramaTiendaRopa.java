...
public class ProgramaTiendaRopa {
    public static void main(String[] args) {
        ...
        // Creo objetos de los productos como ejemplos que "Estarian" almacenados en una base de datos donde el 
        // empleado puede consultar la disponibilad
        // CAMISETAS
        Camiseta c1 = new Camiseta(1, 10, 1, 2023, "Nike"); 
        // los atributos heredados de las subclase y superclase
        // atributos propios de camiseta los llamo desde el metodo propio de la clase
        c1.setTalla("M");  
        c1.setColor("BLANCO"); 
        Camiseta c2 = new Camiseta(1, 19.9, 1, 2023, "Adidas"); 
        // los atributos heredados de las subclase y superclase
        // atributos propios de camiseta los llamo desde el metodo propio de la clase
        c2.setTalla("M");
        c2.setColor("NEGRO");
        Camiseta c3 = new Camiseta(1, 25.99, 2, 2022, "Ellesse"); 
        // los atributos heredados de las subclase y superclase
        // atributos propios de camiseta los llamo desde el metodo propio de la clase
        c3.setTalla("M");
        c3.setColor("ROJO");                            
        // PANTALONES
        Pantalon p1 = new Pantalon(1, 39.9, 15, 2023,"Levis"); 
        // los atributos heredados de las subclase y superclase
        // atributos propios de camiseta los llamo desde el metodo propio de la clase
        p1.setTalla(34);
        p1.setColor("Vaquero Claro");
        Pantalon p2 = new Pantalon(1, 59.9, 9, 2022, "Guchy"); 
        // los atributos heredados de las subclase y superclase
        // atributos propios de camiseta los llamo desde el metodo propio de la clase
        p2.setTalla(36);
        p2.setColor("Negro");
        Pantalon p3 = new Pantalon(1, 19.9, 10, 2022, "Grimey"); 
        // los atributos heredados de las subclase y superclase
        // atributos propios de camiseta los llamo desde el metodo propio de la clase
        p3.setTalla(40);
        p3.setColor("Vaquero Clasico"); 
        // ZAPATILLAS
        Zapatillas z1 = new Zapatillas(1, 259.9, 521, 2019, "Air Jordan"); 
        // los atributos heredados de las subclase y superclase
        // atributos propios de camiseta los llamo desde el metodo propio de la clase
        z1.setTalla(42);
        z1.setColor("ROJO/NEGRO");
        Zapatillas z2 = new Zapatillas(1, 179.9, 519, 2021, "Nike Air Max"); 
        // los atributos heredados de las subclase y superclase
        // atributos propios de camiseta los llamo desde el metodo propio de la clase
        z2.setTalla(43);
        z2.setColor("BLANCO");
        Zapatillas z3 = new Zapatillas(1, 599.9, 505, 2018, "Reebook Pump"); 
        // los atributos heredados de las subclase y superclase
        // atributos propios de camiseta los llamo desde el metodo propio de la clase
        z3.setTalla(45);
        z3.setColor("NEGRA/BLANCA");
        // Para mostrar la app por consola lo resuelvo con un menu con varias opciones con una variable que guarda 
        // la opcion que voy a marcar y un while para asegurarme que no se salga de las opciones que he definido
        int opcion=1; 
        while(opcion!=4){
            ...
            switch(opcion){
                case 1:
                // llamando al metodo toString voy a mostrar los datos de los objetos almacenados
                ...
                break;
                case 2:
                // para introducir ficticiamente nuevos productos defino variables para meter los datos en el constructor 
                // asi los nuevos objetos que vaya metiendo se ira viendo por consola como te va pidiendo todos los parametros uno a uno
                System.out.println("Introduce un nuevo producto");
                // resuelvo esta opcion con un switch dentro del switch principal
                int opcionProd=1;
                while(opcionProd!=4){
                    ...
                    switch(opcionProd){
                        ...
                        System.out.println("---------------------------------------------------------------------");
                        System.out.println("TALLA(S/M/L/XL): ");
                        ...
                        System.out.println("---------------------------------------------------------------------");
                        System.out.println("TALLA(VALOR NUMERICO): ");
                        ...
                        break;
                        case 4:
                        System.out.println("VOLVIENDO ATRAS"); // con esta opcion vuelves al menu anterior
                        default:
                ...
                break;
                case 3:
                /* creo una lista usando la herramienta ArrayList donde voy a guardar los objetos del inventario creados antes (opcion 1 menu)
                El ArrayList va a ser del tipo TiendaRopa puesto que es la SuperClase de los objetos que se van guardar ahi
                tambien puede crearse el objeto de tipo Object que es la clase por excelencia pero lo he creado del tipo de
                la superclase para que herede exactamente los metodos que quiero*/
                ...
                asi sucesivamente hasta que recorra los 9 objetos creados*/
                System.out.println("---------------------------------------------------------------------"); 
                ...
                mi idea es que funcione como un indice para que todos los objetos esten localizados*/
                int contador=1;
                for(Object producto : inventario){
                    ...
                    // va aumentando de uno en uno hasta recorrerlos todos
                    contador++;
                }
                System.out.println("Cuantos productos vas a comprar");
                // creo una variable para seleccionar cuantos elementos del ArrayList voy a seleccionar
                int numProductos=sc.nextInt();
                /* declaro otro ArrayList del tipo de la superclase donde voy a guardar los elementos que 
                quiera del anterior ArrayList(Inventario)*/
                ArrayList<TiendaRopa> carritoCompra = new ArrayList<>(); 
                System.out.println("---------------------------------------------------------------------"); 
                // FOR que recorre los productos seleccionados
                for(int i=0;i<numProductos;i++){
                    ...
                    y resto -1 porque el Array empieza en 0 y el contador empieza en 1 asi buscara la posicion correcta*/
                ...
                for(TiendaRopa producto : carritoCompra){
                    ...
                    /* en esta operacion obtengo el precio del producto y lo sumo a lo que valga precio compra
